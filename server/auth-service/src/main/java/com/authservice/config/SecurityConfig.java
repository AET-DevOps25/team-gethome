...
public class SecurityConfig {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/v1/auth/register", "/api/v1/auth/login", "/api/v1/auth/verify-email", 
                               ...
                               "/api/v1/auth/reset-password", "/actuator/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://react-client", "http://react-client:80")); // Add your frontend URL
